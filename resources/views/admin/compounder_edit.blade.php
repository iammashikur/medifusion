                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('compounder.update', $compounder->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <div id="image-preview" class="image-preview"
                                    style="background-image: url({{ asset("/uploads/images/$compounder->avatar") }}); background-size: cover; background-position: center center;">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <select class="form-control selectric" name="gender" required>
                                    ...
                                    @foreach ($gender as $genders)
                                        <option @if ($compounder->gender == $genders->id) selected @endif
                                            value="{{ $genders->id }}">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <button class="btn btn-primary">Update Compounder</button>
                            </div>
                        </div>
                    </form>
                </div>
