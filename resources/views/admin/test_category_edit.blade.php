                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('test-category.update', $test_category->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <div id="image-preview" class="image-preview"
                                    style="background-image: url({{ asset("/uploads/images/$test_category->image") }}); background-size: cover; background-position: center center;">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <input type="text" name="name" class="form-control" value="{{ $test_category->name}}" required>
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3"></label>
                            <div class="col-sm-12 col-md-7">
                                <button class="btn btn-primary">Update Test Category</button>
                            </div>
                        </div>
                    </form>
                </div>
