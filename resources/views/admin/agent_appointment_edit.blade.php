                ...
                <div class="col-md-6">
                    <div class="card card-primary">
                        ...
                        <div class="card-body" style="overflow-x: auto">
                            ...
                            <form action="{{ route('agent-appointment.update', $appointment->id) }}" method="POST"
                                ...
                                <div class="form-group mb-2">
                                    ...
                                    <input type="text" class="form-control" name="" id="" aria-describedby="helpId"
                                        placeholder="{{ $appointment->getDoctor->name }}" disabled>
                                ...
                                <div class="form-group mb-2">
                                    ...
                                    <input type="text" class="form-control" name="" id="" aria-describedby="helpId"
                                        placeholder="{{ $appointment->getPatient->name }}" disabled>
                                ...
                                <div class="form-group mb-2">
                                    ...
                                    <Textarea type="text" class="form-control h-100" name="" id="" aria-describedby="helpId" rows="6" disabled>District : {{ $appointment->getLocation->getDistrict->name }}
                                    ...
                                    <select class="form-control" name="status_id" id="">
                                        @foreach (App\Models\AppointmentStatus::get() as $item)
                                            <option value="{{ $item->id }}"
                                                @if ($item->id == $appointment->status_id) selected @endif> {{ $item->status }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
